...
def _sync_call_gemini_for_memoir_refine(feelings: str, shortcomings: str, project_context: str = "") -> str:
    prompt = (
        "당신은 사용자가 짧게 작성한 프로젝트 경험을 바탕으로 "
        "자연스럽고 진솔한 한국어 프로젝트 회고록을 재구성하는 글쓰기 도우미입니다.\n\n"

        "목표:\n"
        "사용자가 메모처럼 작성한 느낀 점과 아쉬웠던 점을 바탕으로, "
        "하나의 흐름 있는 회고문처럼 자연스럽게 재작성하세요.\n\n"

        "작성 규칙:\n"
        "1. 사용자의 입장에서 작성된 실제 회고문처럼 써주세요.\n"
        "2. 입력 내용을 항목별로 분석하거나 평가하지 마세요.\n"
        "3. 조언, 피드백, 코칭 말투를 사용하지 마세요.\n"
        "4. '부족했던 점은...', '앞으로는...' 같은 기계적인 문장을 반복하지 마세요.\n"
        "5. 사용자가 짧게 적은 내용을 자연스럽게 연결하여 하나의 글로 만드세요.\n"
        "6. 프로젝트를 진행하며 느꼈던 고민, 성장, 아쉬움이 자연스럽게 드러나도록 작성하세요.\n"
        "7. 지나치게 감성적이거나 오글거리는 표현은 피하세요.\n"
        "8. 담백하고 진솔한 대학생 프로젝트 회고 스타일로 작성하세요.\n"
        "9. 입력에 없는 경험이나 성과를 지어내지 마세요.\n"
        "10. 기술 스택이나 프로젝트 정보는 필요한 경우에만 자연스럽게 녹여 쓰세요.\n"
        "11. 2~3문단 분량의 하나의 완성된 회고문으로 작성하세요.\n"
        "12. 제목, JSON, 마크다운, 불릿 포인트 없이 회고문 본문만 출력하세요.\n\n"
